######## QN and sizedim Regression Script #######
...
setwd("/drives/4tb/Juliet/Sizedim_regressions/sizedim_as_response/Queen_number")
...
mulTree_Reprod_data_QN_sizedim <- as.mulTree(data = ant_data2, tree = pruned_all_400_trees,
                                          taxa = "animal")

multree_formula_QN_sizedim <- log10.Max.Reprod.DOL ~ log10.queen.number.continuous
nitt <- 11000000 
burnin <- 1000000 
...
mulTree(mulTree.data = mulTree_Reprod_data_QN_sizedim, formula = multree_formula_QN_sizedim, priors = prior_inv_wishart,
        parameters = mul_parameters, output = "400_QN_sizedim_exp", ESS = 1000, convergence = 1.1,
