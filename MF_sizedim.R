######## MF and sizedim Regression Script #######
...
setwd("/drives/4tb/Juliet/Sizedim_regressions/sizedim_as_response/Mating_frequency")
...
mulTree_Reprod_data_MF_sizedim <- as.mulTree(data = ant_data2, tree = pruned_all_400_trees,
                                          taxa = "animal")

multree_formula_MF_sizedim <-  log10.Max.Reprod.DOL ~ log10.queen.mating.frequency.original
nitt <- 11000000 
burnin <- 1000000 
...
mulTree(mulTree.data = mulTree_Reprod_data_MF_sizedim, formula = multree_formula_MF_sizedim, priors = prior_inv_wishart,
        parameters = mul_parameters, output = "400_MF_sizedim", ESS = 1000, convergence = 1.1,
