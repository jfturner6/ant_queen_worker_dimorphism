######## sizedim and Colony Size Regression Script #######
...
setwd("/drives/4tb/Juliet/Sizedim_regressions/sizedim_as_response/Colony_size")
...
multree_formula_CS_sizedim <- log10.Max.Reprod.DOL ~ log10.colony.size
...
mulTree(mulTree.data = mulTree_Reprod_data_CS_sizedim, formula = multree_formula_CS_sizedim, priors = prior_inv_wishart,
        parameters = mul_parameters, output = "400_CS_sizedim", ESS = 1000, convergence = 1.1,
