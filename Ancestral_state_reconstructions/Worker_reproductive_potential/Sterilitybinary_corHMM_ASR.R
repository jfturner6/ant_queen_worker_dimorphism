...
ASRdata$sterility_binary <- ifelse(ASRdata$Inherent_Constraints_Scale == 4, "1", "2") # 1 = sterile, 2 = non-sterile

ASRdata$sterility_binary <- as.factor(ASRdata$sterility_binary)
ASRdata2 <-dplyr::select(ASRdata, animal, sterility_binary)
...
setwd("/drives/4tb/Juliet/since_Nov_24/WRP_ASRs/Sterility_binary_ASR/rat2_ARD") #Assign file path for models to be saved
